...
export default function NewProject({ onAdd, onCancel }) {
  ...
  return (
    ...
    <h2 className="text-xl font-bold text-stone-500 my-4">Invalid Input</h2>
      ...
      <p className="text-stone-400 mb-4">To proceed further please enter proper values...</p>
    </Modal>
    <div className="w-[35rem] mt-16 ">
      ...
      <div>
        <Input type="text" required ref={title} label="Title" />
        <Input
          type="text"
          required
          ref={description}
          ...
          isTextarea
        />
        <Input type="date" required ref={dueDate} label="Due Date" />
      </div>
    </div>
    </>
  );
